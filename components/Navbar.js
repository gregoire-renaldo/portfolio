  ...
  return (
    <div className="  max-w-6xl  mx-auto px-6 py-2 md:py-3">
      <div className="flex  md:flex-row justify-between items-center ">
        ...
        <div className="flex flex-col hover:scale-125 ease-in duration-300">
          <Link href="/">
            <a>
        ...
        <div className="space-x-4 flex flex-row items-center">
          ...
          <button
            ...
            type="button"
            className="w-10 h-10 p-3 rounded focus:outline-none hover:scale-125 ease-in duration-300"
